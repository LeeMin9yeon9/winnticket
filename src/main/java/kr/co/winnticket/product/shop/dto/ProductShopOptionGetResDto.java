...
@Schema(title = "[상품 > 옵션 조회] ProductShopOptionGetResDto")
public class ProductShopOptionGetResDto {
    @NotNull
    ...
    private List<ProductShopOptionValueGetResDto> values = new ArrayList<>();
}
